## Planificacion:
En este primer puerto (21), fui bastante directo, habia mucha informacion a la vista, tenia un puerto y una version exacta, asi que lo primero que hice fue pasarlo por la herramienta 'searchploit'.
...
### Metasploit:
Metasploit es un framework de pentesting donde hay miles de exploits y payloads en un solo lugar.
...
Aqui encontre el exploit que habia que usar, y con el comando 'use' lo prepare, despues puse quien era el atacante y quien la victima con 'set LHOST' y 'set RHOST'.

<img width="861" height="416" alt="imagen" src="https://github.com/user-attachments/assets/99824448-d939-456c-9cca-86a6c78c9b0a" />

Y por ultimo con el comando exploit se ejecuta y se abre una terminal Meterpeter, una terminal con herramientas de post explotación, en la maquina victima.
